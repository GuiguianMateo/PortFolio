...
<body class="bg-blue-1500 text-white">
    ...
    <div class=" lg:mt-8 mb-8 p-4 mx-auto">
        ...
        <div class=" justify-center my-40 px-0 sm:px-10 lg:py-10
                    border-white border-2 rounded-md mx-5
                    lg:flex justify-center lg:gap-28
                    xl:gap-40 xl:mx-28">

            <div >
                <img class="rounded-full bg-white w-20 h-20 mx-auto
            ...
            <div class="md:flex justify-center bg-blue-1500
                            border-white border-2 rounded-md">

                <div class="my-auto">
                    <a  href="tel:0659086613"
                        class="bg-gray-500/50 hover:text-sky-800 flex rounded-md m-5 p-5">
                        <img src="assets/img/call.png" class="mr-4 my-auto">
                        0659086613
                    </a>
                    <a  href="mailto:mateo.guiguian@orange.fr"
                        class="bg-gray-500/50 hover:text-sky-800 flex rounded-md m-5 p-5">
                        <img src="assets/img/email.png" class="mr-4 my-auto">
                        <p class="">mateo.guiguian@orange.fr</p>
                        <!-- Systeme switch text pour responsive à la main css -->
                    </a>
                </div>                                                      
